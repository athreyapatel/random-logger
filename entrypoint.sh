...
do
   ...
   D=`date -Iseconds`
   case "$I" in
      "1") echo '{"severity":"ERROR","@type":"type.googleapis.com/google.devtools.clouderrorreporting.v1beta1.ReportedErrorEvent","level":50,"timestamp":"2020-09-30T20:19:06.210Z","pid":17,"hostname":"123","name":"xyz","message":"RequestId: 9fcf7a84-73a7-4bcd-b022-c63afaee8d3c, route: /api/v1/transfer/?after=2020-09-30T04:14:08.290779Z, method: GET, appBuildEnv: dev, appVersion :1.7.02 An error occurred while fetching logs error:"}'
      ;;
